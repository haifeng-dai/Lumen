...
pub enum I18nKey {
    ...
    ExportLibraryFailed,
    ExportLibrarySelectFolder,
    ImportLibrary,
    ImportLibrarySuccess,
    ImportLibraryFailed,
    ImportLibrarySelectPackage,
    Confirm,
    LoadingMetadata,
    FetchFailed,
    Retry,
    ...
    BatchRename,
    BatchRenameCompleted,
    BatchRenameCompletedWithFailures,
    BatchRenameFailed,
    BatchRenameSourceNotRegularFile,
    BatchRenameSourceNameUnreadable,
    BatchRenameTargetExists,
    BatchRenameRenameFailed,
    BatchRenameSaveFailed,
    ...
    DatabaseSyncConflictsCount,
    DatabaseSyncFailuresCount,
    TestConnection,
    WebDavSettings,
    EnableWebDav,
    DatabaseSettings,
